...
const Home = ({ intl }) => (
  <div className="home">
    ...
    <div className="home__start">
      <Container>
        <h1>
          <FormattedMessage id="home.howtoplay" defaultMessage="How To Play" />
        </h1>
        <div className="home__cards">
          <Card
            ...
            description={intl.formatMessage({
              id: 'home.card1.description',
              defaultMessage: 'Select one of the ready to use formations',
            })}
          />
          <Card
            customClass="home__card"
          ...
          <Card
            ...
            title={intl.formatMessage({
              id: 'home.card3.title',
              defaultMessage: "Drag'n Drop",
            })}
            description={intl.formatMessage({
              id: 'home.card3.description',
              defaultMessage: 'Modify your formation via drag and drop',
            })}
          />
        </div>
      </Container>
