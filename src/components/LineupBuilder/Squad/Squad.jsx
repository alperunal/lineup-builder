  ...
  <div className="squad">
    <table className="player-table">
      <thead>
        <tr>
          <td className="player-table__name">
            <FormattedMessage id="squad.player" defaultMessage="Player" />
          </td>
          <td className="player-table__no">
            <FormattedMessage id="squad.no" defaultMessage="No" />
          </td>
      ...
      <tbody>
        {players.map((player) => (
          <tr key={player.id}>
            <td className={cn('player-table__name')}>
            ...
            <td className={cn('player-table__no')}>
              <span className="form-group">
                <input
                  type="text"
                  value={player.num}
            ...
            <td className={cn('player-table__icon')}>
              <span className="form-group">
                <input
                  type="checkbox"
                  checked={player.goal}
